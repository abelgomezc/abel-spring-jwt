package com.abel.config.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeRequest -> {
                    authorizeRequest.requestMatchers(HttpMethod.POST,"api/v1/user/registereUser").permitAll();
//                    authorizeRequest.requestMatchers(HttpMethod.GET,"api/v1/user/listUsuarios").permitAll();
                    ...
                    authorizeRequest.requestMatchers(HttpMethod.GET,"api/v1/cliente/listarClientes").permitAll();
